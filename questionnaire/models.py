...
class Survey(models.Model):
    ...
    status = models.SmallIntegerField(
        "问卷状态", choices=Status.choices, default=Status.REVIEWING)
...
class AnswerSheet(models.Model):
    ...
    status = models.SmallIntegerField(
        "问卷状态", choices=Status.choices, default=Status.DRAFT)
...
class Question(models.Model):
    ...
    survey = models.ForeignKey(
        Survey, on_delete=models.CASCADE, verbose_name="所属问卷")
...
class AnswerText(models.Model):
    ...
    '''
    question = models.ForeignKey(
        Question, on_delete=models.CASCADE, verbose_name="对应问题")
