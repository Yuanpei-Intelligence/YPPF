    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "badge",
                    models.ImageField(
                        upload_to="achievement/badges/", verbose_name="徽章"
                    ),
                ),
                (
                    "avatar",
                    models.ImageField(
                        upload_to="achievement/avatars/", verbose_name="图标"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "auto_trigger",
                    models.BooleanField(default=False, verbose_name="自动触发"),
                ),
                (
                    "reward_points",
                    models.PositiveIntegerField(default=0, verbose_name="奖励积分"),
                ),
                (
                    "achievement_type",
                    models.ForeignKey(
