...
urlpatterns = [
    ...
    path("freshman/", views.FreshmanView.as_view(), name="freshman"),
    path("alumnus/", views.AlumnusView.as_view(), name="alumnus"),
    path("register/", views.authRegister, name="register"),
    path("registerSuccess/", views.RegisterSuccessView.as_view(), name="registerSuccess"),
