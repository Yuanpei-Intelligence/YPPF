...
urlpatterns = [
    ...
    path("profile/tags/update/", profile_views.updateProfileTags,
         name="updateProfileTags"),
    path("profile/tags/<int:selection_id>/story/", profile_views.updateTagStory,
         name="updateTagStory"),
    path("profile/activities/<int:participation_id>/story/",
         profile_views.updateActivityStory, name="updateActivityStory"),
    path("profile/activity-stories/<int:story_id>/like/",
         profile_views.toggleActivityStoryLike, name="toggleActivityStoryLike"),
    path("profile/activity-stories/<int:story_id>/comments/",
         profile_views.addActivityStoryComment, name="addActivityStoryComment"),
    path("profile/skill-stories/<int:selection_id>/like/",
         profile_views.toggleTagStoryLike, name="toggleTagStoryLike"),
    path("profile/skill-stories/<int:selection_id>/comments/",
         profile_views.addTagStoryComment, name="addTagStoryComment"),
    path("profile/tag-stories/<int:selection_id>/like/",
         profile_views.toggleTagStoryLike, name="toggleProfileTagStoryLike"),
    path("profile/tag-stories/<int:selection_id>/comments/",
         profile_views.addTagStoryComment, name="addProfileTagStoryComment"),
    path("profile/activity-stories/<int:story_id>/delete/",
         profile_views.deleteActivityStory, name="deleteActivityStory"),
    path("community/activities/", profile_views.CommunityBoard.as_view(),
         {"board": "activities"}, name="activityCommunity"),
    path("community/skills/", profile_views.CommunityBoard.as_view(),
         {"board": "skills"}, name="skillCommunity"),
