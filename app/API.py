...
def get_wallpaper_url(valid_user: User):
    '''返回合法用户壁纸的URL相对路径'''
    user_type = __check_type(valid_user)[1]
    obj = __get_obj(valid_user, user_type)
