    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "directed",
                    models.BooleanField(default=False, verbose_name="是否定向"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False, verbose_name="是否发起过非定向提问"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tag_content",
                    models.CharField(max_length=63, verbose_name="标签内容"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "year",
                    models.IntegerField(
                        default=app.models.current_year, verbose_name="开课年份"
                    ),
                ),
                (
                    "semester",
                ...
                (
                    "times",
                    models.SmallIntegerField(default=16, verbose_name="课程开设周数"),
                ),
                (
                    "classroom",
                    models.CharField(
                ...
                (
                    "teaching_plan",
                    models.TextField(
                        blank=True, default="暂无", verbose_name="教学计划"
                    ),
                ),
                (
                    "record_cal_method",
                    models.TextField(
                        blank=True, default="暂无", verbose_name="学时计算方式"
                    ),
                ),
                (
                    "status",
                ...
                (
                    ...
                    models.IntegerField(default=0, verbose_name="当前选课人数"),
                ),
                (
                    "publish_day",
                    models.SmallIntegerField(default=3, verbose_name="信息发布时间"),
                ),
                (
                    "need_apply",
                ...
                (
                    "QRcode",
                    models.ImageField(
                        blank=True, null=True, upload_to="course/QRcode/%Y/"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "extra_name",
                    models.CharField(
                        blank=True, max_length=60, verbose_name="课程名称额外标注"
                    ),
                ),
                (
                    "year",
                    models.IntegerField(
                        default=app.models.current_year, verbose_name="课程所在学年"
                    ),
                ),
                (
                    "semester",
                ...
                (
                    "attend_times",
                    models.IntegerField(default=0, verbose_name="参加课程次数"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "info",
                    models.TextField(blank=True, default="", verbose_name="相关信息"),
                ),
                (
                    "time",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "start_time",
                    models.DateTimeField(
                        auto_now_add=True, verbose_name="通知发出时间"
                    ),
                ),
                (
                    "finish_time",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="通知处理时间"
                    ),
                ),
                (
                    "typename",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "otype_name",
                    models.CharField(max_length=25, verbose_name="小组类型名称"),
                ),
                (
                    "otype_superior_id",
                    models.SmallIntegerField(
                        default=0, verbose_name="上级小组类型编号"
                    ),
                ),
                (
                    "job_name_list",
                ...
                (
                    ...
                    models.SmallIntegerField(
                        default=0, verbose_name="管理者权限等级上限"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(default=0, verbose_name="空盒元气值补偿下限"),
                ),
                (
                    "empty_YQPoint_compensation_upperbound",
                    models.IntegerField(default=0, verbose_name="空盒元气值补偿上限"),
                ),
                ("start", models.DateTimeField(verbose_name="开始时间")),
                (
                    "end",
                ...
                (
                    "redeem_start",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="兑奖开始时间"
                    ),
                ),
                (
                    "redeem_end",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="兑奖结束时间"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "exchange_limit",
                    models.IntegerField(default=0, verbose_name="单人兑换上限"),
                ),
                (
                    "exchange_price",
                    models.IntegerField(blank=True, null=True, verbose_name="价格"),
                ),
                (
                    "exchange_attributes",
                    models.JSONField(blank=True, default=list, verbose_name="属性"),
                ),
                (
                    "is_big_prize",
                    models.BooleanField(default=False, verbose_name="是否特别奖品"),
                ),
                (
                    "is_empty_prize",
                    models.BooleanField(default=False, verbose_name="是否空盒"),
                ),
            ],
            options={
                "verbose_name": "5.奖池奖品",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "attributes",
                    models.JSONField(blank=True, default=dict, verbose_name="属性"),
                ),
                (
                    "status",
                    models.CharField(
                ...
                (
                    "redeem_time",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="兑奖时间"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_admin",
                    models.BooleanField(default=False, verbose_name="是否是负责人"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "more_info",
                    models.CharField(
                        blank=True, default="", max_length=255, verbose_name="详情"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "text",
                    models.TextField(blank=True, default="", verbose_name="心愿内容"),
                ),
                (
                    "time",
