    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Sid', models.IntegerField(max_length=64, verbose_name='学号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ostatus', models.BooleanField(verbose_name='激活状态')),
                ('YQPoint', models.FloatField(default=0.0, verbose_name='元气值')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('proposer', models.CharField(max_length=64, verbose_name='转账方')),
                ('proposer_id', models.CharField(max_length=64, verbose_name='转账方学号')),
                ('recipient', models.CharField(max_length=64, verbose_name='收款方')),
                ('recipient_id', models.CharField(max_length=64, verbose_name='收款方学号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('oincharge', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.naturalperson')),
            ],
        ),
        migrations.AddField(
