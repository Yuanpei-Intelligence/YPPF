...
def selectCourse(request):
    ...
    html_display["pubulish_time"] = get_setting("course/pubulish_time")
    ...
    elif (str_to_time(html_display["yx_election_end"])) <= datetime.now() < (str_to_time(html_display["pubulish_time"])):
    ...
    is_drawing = (str_to_time(html_display["yx_election_end"]) <= datetime.now()
                   <= str_to_time(html_display["pubulish_time"]))
