...
@utils.except_captured(source='views[index]')
def index(request):
...
@utils.except_captured(source='views[shiftAccount]')
...
@utils.except_captured(source='views[miniLogin]')
...
@utils.except_captured(source='views[stuinfo]')
...
@login_required(redirect_field_name="origin")
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[request_login_org]')
...
@login_required(redirect_field_name="origin")
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[user_login_org]')
...
@login_required(redirect_field_name="origin")
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[orginfo]')
...
@login_required(redirect_field_name="origin")
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[homepage]')
...
@login_required(redirect_field_name="origin")
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[account_setting]')
...
@utils.except_captured(source='views[freshman]')
...
@login_required(redirect_field_name="origin")
@utils.except_captured(source='views[user_agreement]')
...
@utils.except_captured(source='views[auth_register]')
...
@utils.except_captured(source='views[logout]')
def logout(request):
    auth.logout(request)
    return HttpResponseRedirect("/index/")
...
"""
@utils.except_captured(source='views[org_spec]')
...
@utils.except_captured(source='views[get_stu_img]')
...
@login_required(redirect_field_name="origin")
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[search]')
def search(request):
    """
        搜索界面的呈现逻辑
...
@utils.except_captured(source='views[forget_password]')
...
@utils.except_captured(source='views[modpw]')
def modpw(request):
    """
...
@login_required(redirect_field_name="origin")
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[transaction_page]')
...
@utils.except_captured(source='views[confirm_transaction]')
...
@login_required(redirect_field_name="origin")
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[myYQPoint]')
...
@login_required(redirect_field_name="origin")
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[viewActivity]')
...
@login_required(redirect_field_name="origin")
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[getActivityInfo]')
...
@login_required(redirect_field_name="origin")
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[checkinActivity]')
...
@login_required(redirect_field_name="origin")
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[addActivity]')
...
@login_required(redirect_field_name="origin")
@utils.except_captured(source='views[examineActivity]')
...
@login_required(redirect_field_name="origin")
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[subscribeOrganization]')
...
@login_required(redirect_field_name="origin")
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[save_show_position_status]')
...
@login_required(redirect_field_name="origin")
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[save_subscribe_status]')
...
@login_required(redirect_field_name="origin")
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[apply_position]')
...
@login_required(redirect_field_name="origin")
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[notifications]')
...
@utils.except_captured(source='views[addComment]')
...
@login_required(redirect_field_name='origin')
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[showNewOrganization]')
...
@login_required(redirect_field_name='origin')
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[modifyPosition]')
...
@login_required(redirect_field_name='origin')
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[showPosition]')
...
@login_required(redirect_field_name="origin")
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[endActivity]')
...
@login_required(redirect_field_name="origin")
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[showActivity]')
...
@login_required(redirect_field_name="origin")
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[modifyEndActivity]')
...
@login_required(redirect_field_name='origin')
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[modifyOrganization]')
...
@login_required(redirect_field_name='origin')
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[sendMessage]')
...
@login_required(redirect_field_name='origin')
@utils.check_user_access(redirect_url="/logout/")
@utils.except_captured(source='views[QAcenter]')
