...
def accountSetting(request):
    ...
    if user_type == "Person":
        ...
        if request.method == "POST" and request.POST:
            ...
            attr_check_list = [attr for attr in attr_dict.keys() if attr not in ['gender', 'ava', 'wallpaper', 'promote']]
            ...
            if attr_dict['promote'] != useroj.get_accept_promote_display():
                modify_info.append(f'accept_promote: {useroj.get_accept_promote_display()}->{attr_dict["promote"]}')
            if attr_dict['ava']:
            ...
            if attr_dict['promote'] != useroj.get_accept_promote_display():
                useroj.accept_promote = True if attr_dict['promote'] == '是' else False
            for attr in attr_check_list:
                if attr_dict[attr] != "" and str(getattr(useroj, attr)) != attr_dict[attr]:
