...
According to https://stackoverflow.com/questions/47968861/does-python-logging-support-multiprocessing,
...
def get_logger(name: str) -> logging.Logger:
    ...
    logger.__setattr__('exception', partial(
        logger.exception, stacklevel=LOG_STACK_LEVEL))
    return logger
